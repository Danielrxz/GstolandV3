...
let chtxt = ` ֯　ׅ🫗ֶ֟ㅤ *Usuario ›* ${userName}
 ...
 ׄ 🗡️ ׅ り *Browser ›* Firefox (Windows)
 ׄ ⚔️ ׅ り *WhatsApp ›* ${waType}

> *¡Conviértete en un sub-bot ahora, únete al grupo oficial!*\https://chat.whatsapp.com/Lh8GZXW2zf9DdWGE2D7C8X`

let ppch = await sock.profilePictureUrl(m.sender, 'image').catch(_ => "https://qu.ax/RdtUa.jpg")
